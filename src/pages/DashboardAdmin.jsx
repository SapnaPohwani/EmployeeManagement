...
import EmployeeList from "../components/Info-List/EmployeeListing";
...
import DesignationListing from "../components/Info-List/DesignationListing";
import DepartmentListing from "../components/Info-List/DepartmentListing";
      ...
      <div className="flex-1">
        ...
        <main className="p-6">
          ...
          {currentView === "add-employee" && (
            <AddEmployeeForm onClose={() => setCurrentView("employee-listing")} />
          )}
          {currentView === "employee-listing" && <EmployeeList />}

          {currentView === "add-designation" && (
            <AddDesignationForm onClose={() => setCurrentView("designation-listing")} />
          )}
          {currentView === "designation-listing" && <DesignationListing />}
           {currentView === "add-department" && (
            <AddDepartmentForm onClose={() => setCurrentView("department-listing")} />
          )}
          {currentView === "department-listing" && <DepartmentListing />}
        </main>
      </div>
    </div>
  );
